          ...
          {visibleIds.has('test-management') && (
            <ManualSection {...topic('test-management')}>
              ...
              <SopSteps items={[
                ...
                { title: 'Operate in bulk', text: 'Use bulk assignment, execution, or removal after checking the confirmation summary. Adding more than 500 testcases, Excel imports, and lifecycle/repository exports run as background jobs so the page does not wait on one long API request. Export Repository downloads the full project; select a repository folder and use Export folder to download that folder and all nested subfolders with testcase definitions, steps, and review history.' },
