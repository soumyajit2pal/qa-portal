...
import { PRIORITIES, RISK_RATINGS, DEFAULT_SAST_CHECKLIST_ITEMS } from '../../constants'
      ...
      {existingSast ? (
        ...
        <>
          ...
          <p className="muted small" style={{ marginTop: -4, marginBottom: 8 }}>
            ...
            linked SAST request, once raised). Items marked "mandatory" must be ticked before the
