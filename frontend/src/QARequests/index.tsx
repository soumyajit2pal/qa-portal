...
import { Badge, Card, ErrorText, PageHeader, Table } from '../components/Common'
    ...
    <div>
      ...
      {draftNotice && (
        <InfoModal title="Saved as Draft" onClose={() => setDraftNotice(false)}>
          <p style={{ marginTop: -4 }}>
            Your QA Request has been saved as a <strong>Draft</strong> — it has <strong>not</strong> been
            raised yet.
          </p>
          <p className="muted small">
            Nothing happens on any Functional/SAST/DAST/Performance request until you submit
            it. Open this request any time and click "Submit / Raise" when you're ready.
          </p>
        </InfoModal>
      )}
    </div>
