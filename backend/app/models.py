...
class SecurityScanResult(Base):
    ...
    suppressed_critical_count = Column(Integer, nullable=False, default=0)
    suppressed_high_count = Column(Integer, nullable=False, default=0)
    suppressed_medium_count = Column(Integer, nullable=False, default=0)
    suppressed_low_count = Column(Integer, nullable=False, default=0)
